...
#define APP_TURN_SLOW_SCALE        (0.25f)  /* 接近终点后的减速比例 */

#define APP_TURN_DEFAULT_OUT_DUTY  (95.0f)  /* 外侧轮前进 duty，越大转得越快 */
#define APP_TURN_DEFAULT_IN_DUTY   (-43.0f) /* 内侧轮反转 duty，越负越像原地甩弯 */
