...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, BIN2_Pin|BIN1_Pin|AIN1_Pin|AIN2_Pin
                          |LED1_Pin|LED2_Pin|LED3_Pin|X_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Y_DIR_GPIO_Port, Y_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TB2_AIN1_Pin|TB2_AIN2_Pin|TB2_BIN1_Pin|X_EN_Pin
                          |TB2_BIN2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : TB2_AIN1_Pin TB2_AIN2_Pin TB2_BIN1_Pin TB2_BIN2_Pin */
  GPIO_InitStruct.Pin = TB2_AIN1_Pin|TB2_AIN2_Pin|TB2_BIN1_Pin|TB2_BIN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /*Configure GPIO pin : Y_EN_Pin */
  GPIO_InitStruct.Pin = Y_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Y_EN_GPIO_Port, &GPIO_InitStruct);
